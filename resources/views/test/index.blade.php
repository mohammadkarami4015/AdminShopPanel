...
@section('content')
    ...
    <script>
        function activate(id) {
            ...
            console.log(value)
            $.get(`/active/test/${id}/${value}`,{id: id,value:value}, function(result){
            });
        }
        $('#search').on('click',function () {
            var value =$('#searchInput').val();
            $.get(`/search/in/tests/{value}`,{value:value}, function(result){
                $('#myTable').html(result)
            });
        })
    </script>
