        ...
        <div class="col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1">
            <div class="ibox">
                <div class="ibox-content">
                    <form  method="POST" id="form" action="{{ route('test.store') }}" class="form-horizontal" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('sub_desc') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea name="sub_desc"  cols="50" rows="5">{{ old('sub_desc')}}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('desc') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <textarea name="desc" id="summernote" cols="50" rows="10">{{ old('desc')}}</textarea>
                                @if ($errors->has('desc'))
                                    <span class="help-block">
