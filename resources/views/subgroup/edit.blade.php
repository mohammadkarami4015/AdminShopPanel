...
@section('content')
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            <h2>ویرایش زیرگروه</h2>
            <ol class="breadcrumb">
                <li>
                    <a href="">خانه</a>
                </li>
                <li>
                    <a href="{{route('subgroup.index')}}">زیرگروه ها</a>
                    <a> </a>
                </li>
                <li class="active">
                    <strong>ویرایش زیرگروه </strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
        ...
        <div class="col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1">
            <div class="ibox">
                <div class="ibox-content">
                    <form method="POST" id="form" action="{{ route('subgroup.update',$subgroup) }}"
                            ...
                            <div class="col-md-6">
                                <select id="title" type="text" class="form-control" name="group_id"
                                    ...
                                    @foreach($groups as $group)
                                        <option {{$subgroup->group_id == $group->id ? 'selected' : ''}} value="{{$group->id}}">{{$group->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
