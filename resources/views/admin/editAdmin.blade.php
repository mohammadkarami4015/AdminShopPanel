                ...
                <div class="ibox-content">
                    <form  method="POST" id="form" action="{{ route('admin.updateAdmin',['user'=>$admin->id ]) }}" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('national_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="national_id" type="text" class="form-control" name="national_id"  value="{{ $admin->national_id}}" required>
                        ...
                        <div class="form-group{{ $errors->has('about_me') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea name="about_me" id="about_me" cols="50" rows="10">{{ $admin->about_me}}</textarea>
