                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('news.update',['news'=>$news->id]) }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group{{ $errors->has('sub_title') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6" id="">
                                    <input id="sub_title" type="text" class="form-control" name="sub_title" value="{{ $news->sub_title}}" required >
                            ...
                            <div class="form-group{{ $errors->has('sub_desc') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <textarea name="sub_desc"  cols="70" rows="5">{{ $news->sub_desc}}</textarea>
                            ...
                            <div class="form-group{{ $errors->has('desc') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-12" id="">
                                    <textarea id="summernote" type="text" class="form-control" name="desc" rows="6" required >{{ $news->desc}}</textarea>
                                    @if ($errors->has('desc'))
                                        <span class="help-block">
