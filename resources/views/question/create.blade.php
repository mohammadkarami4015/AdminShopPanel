                    ...
                    <form  method="POST" id="form" action="{{ route('question.store') }}" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="test_id" type="hidden" class="form-control" name="test_id" value="{{$test->id}}" required >
                                @if ($errors->has('title'))
                        ...
                        <div class="form-group{{ $errors->has('question') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea name="question" id="question" cols="50" rows="5">{{ old('question')}}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('answer1') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea name="answer1" id="answer1" cols="50" rows="5">{{ old('answer1')}}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('answer2') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea name="answer2" id="answer2" cols="50" rows="5">{{ old('answer2')}}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('answer3') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea name="answer3" id="answer3" cols="50" rows="5">{{ old('answer3')}}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('answer4') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea name="answer4" id="answer4" cols="50" rows="5">{{ old('answer4')}}</textarea>
