    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="{{route('city.index')}}">شهر ها</a>
                    <a> </a>
                </li>
                <li class="active">
        ...
        <div class="col-md-10 col-md-offset-1 col-lg-8 col-lg-offset-2 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1">
            <div class="ibox">
                <div class="ibox-content">
                    <form method="POST" id="form" action="{{ route('city.update',$city) }}"
                            ...
                            <div class="col-md-6">
                                <select id="title" type="text" class="form-control" name="country_id"
                                    ...
                                    @foreach($countries as $country)
                                        <option {{$city->county_id == $country->id ? 'selected' : ''}} value="{{$country->id}}">{{$country->title}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <select id="title" type="text" class="form-control" name="status"
                                        required>
                                    <option {{$city->status == 'on' ? 'selected' : ''}} value="on">فعال</option>
                                    <option {{$city->status == 'off' ? 'selected' : ''}} value="off">غیرفعال</option>
                                </select>
                            </div>
                        </div>
