    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>ویرایش پاسخ آزمون ها</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading"> ویرایش پاسخ آزمون   </div>

                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('result.update',['result'=>$result->id]) }}" >
                            {{ csrf_field() }}
                            {{method_field('PATCH')}}
                                ...
                                <div class="col-md-6">
                                    <select  class="form-control" name="test_id" id="" >
                                        ...
                                        @foreach($tests as $test)
                                            <option value="{{$test->id}}" @if($test->id==$result->test_id) selected @endif>{{$test->title}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6" id="">
                                    <input id="title" type="text" class="form-control" name="title" value="{{ $result->title }}" required >
                                    @if ($errors->has('title'))
                            ...
                            <div class="form-group{{ $errors->has('tip') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6" id="">
                                    <input id="tip" type="text" class="form-control" name="tip" value="{{$result->tip}}" required >
                                    @if ($errors->has('tip'))
                                        <span class="help-block">
                            ...
                            <div class="form-group{{ $errors->has('value') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-12" id="">
                                    <textarea id="summernote" type="text" class="form-control" name="value" cols="500" rows="30"  >{!! $result->value !!}</textarea>
                                    @if ($errors->has('value'))
                                        <span class="help-block">
